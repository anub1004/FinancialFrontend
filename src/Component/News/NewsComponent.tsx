    ...
    <article className="group bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow duration-200 flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mb-2 flex-wrap">
          ...
          {sourceName && (
            <span className="font-medium text-violet-600 dark:text-violet-400 truncate max-w-[140px]">
              {sourceName}
            </span>
          )}
          {timeAgo && (
        ...
        <a
          ...
          className="mt-3 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-violet-600 rounded-lg hover:bg-violet-700 transition-colors self-start"
        >
          Read More
